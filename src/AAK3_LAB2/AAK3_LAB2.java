...
public class AAK3_LAB2 {
    ...
    public static void main(String[] args) {
         try {
            ...
            ResultSet table = statement.executeQuery("SELECT * FROM shop");
            ...
            statement.execute("INSERT shop(coin, price) VALUES ('" + scannedName + "', '" + scannedManufacturer + "')");
            
            System.out.println("После добавления:");
            // Выполнение запроса к базе данных, получение набора данных
            table = statement.executeQuery("SELECT * FROM shop");
            ...
            statement.execute("DELETE FROM shop WHERE id = " + scannedId);
        ...
        sc.nextLine();
            ...
            table = statement.executeQuery("SELECT * FROM shop WHERE coin like '%"+filter+"%'" );  
